...
import uz.abdurashidov.notesapp.domain.usecases.AddNoteUseCase
import uz.abdurashidov.notesapp.domain.usecases.AddNoteUseCase_Factory
import uz.abdurashidov.notesapp.domain.usecases.GetNoteByIdUseCase
...
class DetailViewModel @AssistedInject constructor(
    ...
    fun onBookmarkChange(isBookmark: Boolean) {
        state = state.copy(isBookmarked = isBookmark)
    }
...
class DetailViewModelFactory(
    private val noteId: Long, private val assistedFactory: DetailAssistFactory
